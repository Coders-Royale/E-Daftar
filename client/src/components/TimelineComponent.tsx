    ...
    <div>
      ...
      <div
        className={` ${
          ...
          `border-l-1 border-gray-450`
        } h-16 ml-2`}
      >
        <h1 className="text-xxs font-normal text-gray-550 dark:text-gray-450 pl-5">{`${time}, ${date}`}</h1>
        ...
        {status === Status.Pending && (
          <div className="flex flex-row gap-1 items-center pl-5">
            <h1 className="text-sm font-medium text-gray-650 dark:text-gray-350">
              {status}
            </h1>
            <img // change the icon according to status.
              src={Pending}
