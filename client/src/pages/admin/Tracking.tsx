  ...
  return (
    <div className="h-screen flex bg-gray-350 overflow-hidden">
      ...
      <div className="w-full px-10 overflow-scroll">
        <h1 className="mt-12 text-lg font-medium tracking-widest">
          TRACKING
        </h1>
        ...
        <div className="bg-white h-screen rounded-2xl mt-8 shadow-xl px-12 py-8 mb-12">
          <div className="bg-gray-150 border border-gray-450 rounded-lg h-11 flex flex-row">
            ...
            <input className='bg-gray-150 h-8 my-auto mx-4 px-2 text-sm' placeholder='Enter Tracking ID'></input>
          </div>
          ...
          {/*Timeline Content*/}
            <div className="w-2/5">
              <h1 className='text-gray-750 text-sm font-bold tracking-widest'>TRACKING ID</h1>
              <div className='flex flex-row pt-4 items-center gap-2'>
                <img
                  ...
                  className="w-4 h-4"
                />
                <h1 className="text-base font-medium text-gray-650">#43210, <span className='text-sm'>John Doe</span></h1>
              </div>
              <div className='flex flex-row pt-1 items-center gap-2'>
                <img
                  ...
                  className="w-4 h-4"
                />
                <h1 className="text-xs font-medium text-gray-550">11:30 PM, 11 July, 2022 (Monday)</h1>
              </div>

              <h1 className='text-gray-750 text-sm font-bold tracking-widest pt-8'>CURRENT STATUS</h1>
              <div className='flex flex-row pt-4 items-center gap-2'>
                <img
                  src={GreenTick}
                  alt=""
                  className="w-4 h-4"
                />
                <h1 className="text-base font-medium text-green-550">Approved <span className='text-sm text-gray-650'>by Mr. Venkatesh Iyer</span></h1>
              </div>
              <div className='flex flex-row pt-1 items-center gap-2'>
                <img
                  src={Clock}
              ...
              <h1 className='text-gray-750 text-sm font-bold tracking-widest pt-8 pb-4'>TRACKING</h1>
            ...
            <div className="w-3/5 border-l-2 border-gray-350 px-12">
              <h1 className='text-gray-750 text-sm font-bold tracking-widest'>EMAIL CONTENT</h1>
