  ...
  return (
    ...
    >
      ...
      <div className="w-full px-10 overflow-scroll">
        <h1
          className={`mt-12 text-lg font-medium tracking-widest ${
            theme === "Dark" ? "text-gray-250" : ""
          } `}
        >
          TRACKING
        </h1>
        ...
        <div
          ...
          } h-screen rounded-2xl mt-8 shadow-xl px-12 py-8 mb-12`}
        >
          <div
            className={`${
              theme === "Dark" ? "bg-gray-850" : "bg-gray-150"
            } border border-gray-450 rounded-lg h-11 flex flex-row`}
          >
            ...
            <input
              className={` ${
                theme === "Dark" ? "bg-gray-850 text-white" : "bg-gray-150"
              } mx-4 px-2 text-sm w-full`}
          ...
          <div className="pt-12 flex flex-row">
            ...
            <div className="w-2/5">
              ...
              <h1
                className={`${
                  theme === "Dark" ? "text-gray-250" : "text-gray-750"
                } text-sm font-bold tracking-widest pt-8`}
              >
                CURRENT STATUS
              </h1>
              <div className="flex flex-row pt-4 items-center gap-2">
                ...
                <h1 className="text-base font-medium text-green-550">
                  ...
                  <span
                    className={`text-sm ${
                      theme === "Dark" ? "text-gray-350" : "bg-gray-650"
                    }`}
                  >
              ...
              <h1
                className={`${
                  theme === "Dark" ? "text-gray-250" : "text-gray-750"
                } text-sm font-bold tracking-widest pt-8 pb-4`}
              >
                TRACKING
              </h1>
            ...
            <div className="w-3/5 border-l-2 border-gray-350 px-12">
              ...
              <div
                className={`pt-4 items-center whitespace-pre-line font-normal text-sm  ${
                  theme === "Dark" ? "text-gray-250" : "text-gray-750"
                }`}
              >
                {emailContent}
