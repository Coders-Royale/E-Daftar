  ...
  return (
    <>
      ...
      <div className="mx-12 mt-24">
        ...
        <div className="rounded-xl mx-24 border-2 border-[#2d5063]">
          <div className="flex flex-row justify-between mr-24">
            <p className="pt-24 pb-20 px-20 text-xl font">
              Keep the list of all the mail you recieved from the office.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-16">
          <div className="text-center md:border-r-2 border-gray-300 mt-16 lg:mt-0">
            ...
            <p className="mt-2 mx-8">
              Roughly 70% of office waste is paper waste. In total an average
              office worker uses 10000 pages per year.
            </p>
          </div>
          ...
          <div className="text-center lg:border-r-2 border-gray-300 mt-16 lg:mt-0">
            ...
            <p className="mt-2 mx-8">
              Feel free to share even large files with unlimited storage. Never
              stop yourself because of space to store.
            </p>
          </div>
          ...
          <div className="text-center md:border-r-2 border-gray-300 mt-16 lg:mt-0">
            ...
            <p className="mt-2 mx-8">
              Fastest speed to sign digitally a document using Technology,
              Machine learning and a lot of research on office problems.
            </p>
          </div>
          ...
          <div className="text-center mt-16 lg:mt-0">
            ...
            <p className="mt-2 mx-8">
              A study by Xerox found that businesses can save 528 hours per
              employee per year by digitizing things.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#2d5063] min-h-screen mt-24">
        <div className="lg:flex lg:flex-row ml-24 items-center">
          ...
          <img
            src={MacbookPro}
            alt="macbook-pro"
            className="w-full lg:w-2/3 float-right"
          />
        </div>
      </div>
      ...
      <div className="mt-24 mx-12">
        ...
        <h1 className="text-5xl text-center mt-8">Experience The Speed</h1>
        <h1 className="text-2xl text-center mt-4">Paperless. Fast. Smooth.</h1>
